...
public class TMCEditDialogController {
	@FXML
	...
	private TMCMainController categoryMain;
	...
	public TMCMainController getTMCMain() {
		return categoryMain;
	}

	public void setTMCMain(TMCMainController categoryMain) {
		this.categoryMain = categoryMain;
	}

	public void setTMCService(TMCService categoryService,
	...
	public void setTMCBeanFields(TMCBean categoryBean,
	...
	@FXML
	public void handleTMCStatusAction() {
	...
	private void handleSubmitGenerator() throws SQLException {
		if (isValidate(actionBtnString)) {
			...
			if (actionBtnString.equals("search")) {
				categoryMain.refreshTMCTable(categoryService
				...
				if (actionBtnString.equals("add")) {
					...
					message = "TMC is Saved to the TMC List";
				} else {
					masthead = "Successfully Updated!";
					message = "TMC is Updated to the TMC List";
				}
				categoryService.saveTMC(categoryBean, actionBtnString);
				categoryMain.refreshTMCTable();
